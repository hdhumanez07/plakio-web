...
export const metadata: Metadata = {
  title: "Descargar Plakio — App para parqueaderos",
  description:
    "Descarga la app Plakio para Android e iOS. Gestiona tu parqueadero desde el celular con check-in, check-out y cobro automático.",
  alternates: {
    canonical: `${BASE_URL}/descargar`,
  },
};
      ...
      <main className="flex-1 flex items-center justify-center pt-24 pb-16 px-4 sm:px-6">
        <div className="max-w-lg w-full text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
            Descarga <span className="text-blue-600">Plakio</span>
          </h1>
          <p className="text-gray-500 mb-10">
            Disponible para Android e iOS. Prueba gratis por 30 días, sin
            tarjeta de crédito.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            {/* Android APK */}
            <a
              href="/plakio-0.1.0.apk"
              download
              aria-label="Descargar APK para Android"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-gray-900 text-white hover:bg-gray-800 transition-colors"
            >
              <svg
                viewBox="0 0 24 24"
            ...
            <div
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-gray-100 text-gray-400 cursor-not-allowed"
            >
              <svg
                viewBox="0 0 24 24"
                className="w-6 h-6 shrink-0"
          ...
          <div className="bg-gray-50 rounded-2xl border border-gray-100 p-6 text-left">
            ...
            <ol className="space-y-3">
              {[
                {
                  id: "s1",
                  text: "Descarga la app en tu celular",
                },
                {
                  id: "s2",
                ...
                {
                  id: "s3",
                  text: "Configura tu tarifa y empieza a operar",
                },
              ].map(({ id, text }, i) => (
